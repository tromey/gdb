...
get_running_thread_msymbol ()
{
  ...
  msym = lookup_bound_minimal_symbol (running_thread_name);
  if (!msym.minsym)
    ...
    msym = lookup_bound_minimal_symbol ("running_thread");
...
has_ravenscar_runtime ()
{
  struct bound_minimal_symbol msym_ravenscar_runtime_initializer
    = lookup_bound_minimal_symbol (ravenscar_runtime_initializer);
  struct bound_minimal_symbol msym_known_tasks
    = lookup_bound_minimal_symbol (known_tasks_name);
  struct bound_minimal_symbol msym_first_task
    = lookup_bound_minimal_symbol (first_task_name);
