...
void
mi_cmd_catch_assert (const char *cmd, const char *argv[], int argc)
{
...
void
mi_cmd_catch_exception (const char *cmd, const char *argv[], int argc)
{
  struct gdbarch *gdbarch = get_current_arch();
  std::string condition;
  int enabled = 1;
...
void
mi_cmd_catch_handlers (const char *cmd, const char *argv[], int argc)
{
  struct gdbarch *gdbarch = get_current_arch ();
  std::string condition;
  int enabled = 1;
...
static void
mi_catch_load_unload (int load, const char *argv[], int argc)
{
...
void
mi_cmd_catch_load (const char *cmd, const char *argv[], int argc)
{
...
void
mi_cmd_catch_unload (const char *cmd, const char *argv[], int argc)
{
