...
void
mi_cmd_info_ada_exceptions (const char *command, const char **argv, int argc)
{
...
void
mi_cmd_info_gdb_mi_command (const char *command, const char **argv, int argc)
{
  const char *cmd_name;
  struct mi_cmd *cmd;
  struct ui_out *uiout = current_uiout;
...
void
mi_cmd_info_os (const char *command, const char **argv, int argc)
{
  switch (argc)
    {
    case 0:
