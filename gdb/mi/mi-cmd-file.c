...
void
mi_cmd_file_list_exec_source_file (const char *command, const char **argv,
				   int argc)
{
...
void
mi_cmd_file_list_exec_source_files (const char *command, const char **argv,
				    int argc)
{
  struct ui_out *uiout = current_uiout;
...
void
mi_cmd_file_list_shared_libraries (const char *command, const char **argv,
				   int argc)
{
  struct ui_out *uiout = current_uiout;
  const char *pattern;
