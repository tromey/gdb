...
{
  return unshareable->symtabs[per_cu->index].has_value ();
}
				  ...
				  int warn_if_readin)
{
  ...
  struct dwarf2_per_objfile *dwarf2_per_objfile
    = get_dwarf2_per_objfile (objfile);
  if (warn_if_readin && dwarf2_per_objfile->symtab_set_p (data))
...
dwarf2_psymtab::readin_p (struct objfile *objfile) const
{
  ...
  dwarf2_per_objfile *dwarf2_per_objfile
    = get_dwarf2_per_objfile (objfile);
  return dwarf2_per_objfile->symtab_set_p (per_cu_data);
}
