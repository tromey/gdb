...
yylex (void)
{
  ...
  if (next.token == '.')
      ...
      if (name2.token == NAME)
	{
	  ...
	  if (package_name_p (copy, expression_context_block.block))
	    {
	      popping = 1;
	      ...
	      return classify_packaged_name (expression_context_block.block);
	    }
	}
  ...
  return classify_name (pstate, expression_context_block.block);
}
