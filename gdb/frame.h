...
extern block_symbol get_frame_function (const frame_info_ptr &);
...
extern void read_frame_arg (const frame_print_options &fp_opts,
			    block_symbol sym, const frame_info_ptr &frame,
			    struct frame_arg *argp,
			    struct frame_arg *entryargp);
extern void read_frame_local (block_symbol sym, const frame_info_ptr &frame,
			      struct frame_arg *argp);
