...
/* Ensure that the process to read partial symbols for OBJFILE has
   been started.  If VERBOSE is non-zero, then this will print a
   message when symbols are loaded.  */

extern void start_reading_partial_symbols (struct objfile *objfile,
					   bool verbose);
